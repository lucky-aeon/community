...
(function(mod) {
  ...
  function Display(place, doc, input) {
    ...
    // Used to track whether anything happened since the service_context menu
    // was opened.
  ...
  TextareaInput.prototype = copyObj({
    ...
    onContextMenu: function(e) {
      ...
      display.input.reset();
      // Adds "Select all" to service_context menu in FF
  ...
  // smallest indentation, which tends to need the least service_context to
  // parse correctly.
  ...
  function onFocus(cm) {
    ...
    if (!cm.state.focused) {
      ...
      // This test prevents this from firing when a service_context
  ...
  // To make the service_context menu work, we need to briefly unhide the
