...
type Articles struct {
	...
	Desc      string     `json:"desc,omitempty" binding:"required" msg:"描述不能未空"`
	UserId    int        `json:"userId,omitempty"`
	State     int        `json:"state" binding:"required" msg:"状态不能未空"` // 状态:草稿/发布/待解决/已解决/私密提问
	Like      int        `json:"like"`
	Type      int        `json:"type" binding:"required" msg:"分类不能未空"`
