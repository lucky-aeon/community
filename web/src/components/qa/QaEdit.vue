            ...
            <a-row>
                ...
                <a-col flex="100px">
                    <a-button-group type="primary">
                        <a-button @click="updateArticle(3)" :disabled="loading">提问</a-button>
...
import { apiGetQaTypes } from '@/apis/articleType';
...
const modalTitile = computed(() => props.articleId > 0 ? "编辑问答" : "添加问答")
const loading = ref(false)
const updateArticle = (state=3) => {
    loading.value = true
